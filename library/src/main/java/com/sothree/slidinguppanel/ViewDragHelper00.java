...
public class ViewDragHelper00 {
     ...
     */
    public static ViewDragHelper00 create(ViewGroup forParent, Callback cb) {
        return new ViewDragHelper00(forParent.getContext(), forParent, null, cb);
    }
     ...
     * @return a new ViewDragHelper instance
     */
    public static ViewDragHelper00 create(ViewGroup forParent, Interpolator interpolator, Callback cb) {
        return new ViewDragHelper00(forParent.getContext(), forParent, interpolator, cb);
    }
     ...
     * @return a new ViewDragHelper instance
     */
    public static ViewDragHelper00 create(ViewGroup forParent, float sensitivity, Callback cb) {
        final ViewDragHelper00 helper = create(forParent, cb);
     ...
     * @return a new ViewDragHelper instance
     */
    public static ViewDragHelper00 create(ViewGroup forParent, float sensitivity, Interpolator interpolator, Callback cb) {
        final ViewDragHelper00 helper = create(forParent, interpolator, cb);
        helper.mTouchSlop = (int) (helper.mTouchSlop * (1 / sensitivity));
        return helper;
    }
     ...
     * @param interpolator interpolator for scroller
     */
    private ViewDragHelper00(Context context, ViewGroup forParent, Interpolator interpolator, Callback cb) {
        if (forParent == null) {
